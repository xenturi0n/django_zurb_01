...
//AGREGADA LA VARIABLE PROXY AL DICCIONARIO CONST
...
// Modificado para hacer proxy al servidor de django
function server(done) {
  browser.init({
    notify: false,
    port: PORT,
...
function watch() {
  ...
  //observar las plantillas de django
  gulp.watch('../templates/**/*.html', browser.reload);
}
